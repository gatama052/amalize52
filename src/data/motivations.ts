...
export const MOTIVATIONS: Record<TimeSlot, MotivationEntry> = {
  ...
  menjelangSubuh: {
    ...
    texts: {
      biasa: [
        'Menjelang Subuh adalah waktu yang penuh keberkahan. Luangkan waktu untuk membaca Al-Qur'an atau memperbanyak istighfar.',
  ...
  setelahMaghrib: {
    ...
    texts: {
      biasa: [
        'Setelah Maghrib adalah waktu yang baik untuk membaca Al-Qur'an dan berdzikir.',
        'Luangkan waktu setelah Maghrib untuk tilawah Al-Qur'an agar hati menjadi tenang.',
        'Malam telah tiba. Sempatkan membaca beberapa ayat Al-Qur'an setelah sholat Maghrib.',
        'Setelah Maghrib, manfaatkan waktu untuk membaca Al-Qur'an dan berdzikir kepada Allah.',
      ...
      seninkamis: [
        ...
        'Setelah berbuka, nikmati waktu ini untuk berdzikir dan membaca Al-Qur'an.',
        'Puasa sunnah telah usai. Lanjutkan dengan ibadah malam dan tilawah Al-Qur'an.',
        'Setelah berbuka puasa sunnah, jangan lupa sholat Maghrib dan membaca Al-Qur'an.',
      ],
      jumat: [
        'Malam Jumat adalah waktu yang baik untuk memperbanyak shalawat dan membaca Al-Qur'an.',
        'Setelah Maghrib di malam Jumat, perbanyak shalawat dan tilawah Al-Qur'an.',
        'Malam Jumat yang berkah. Luangkan waktu untuk membaca Al-Qur'an dan bershalawat.',
  ...
  setelahIsya: {
    ...
    texts: {
      biasa: [
        'Setelah Isya, luangkan waktu untuk berdzikir atau membaca Al-Qur'an agar hati menjadi lebih tenang.',
        ...
        'Setelah Isya, bacalah beberapa ayat Al-Qur'an sebelum melanjutkan aktivitas malam.',
 ...
 * Prayer times should be in "HH:MM" format.
 */
...
/**
 * Pick a random motivation text. Uses date-based seed so it stays
 * consistent within the same time slot on the same day but changes daily.
 */
export function getMotivation(
  ...
  // Use day + hour-range as seed for pseudo-random but stable selection
