      ...
      {searchOpen && (
        <form onSubmit={(e) => { e.preventDefault(); handleSearch(); }} className="relative">
          <input
            ...
            className="w-full rounded-xl bg-secondary px-4 py-2.5 pl-10 pr-16 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-accent/30"
            autoFocus
          />
          ...
          <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
            {searchQuery && (
              <button type="button" onClick={clearSearch} className="p-1 text-muted-foreground hover:text-foreground">
