...
export default function DoaPage() {
  ...
  return (
    <div className="animate-fade-in space-y-4">
      <SEOHead title="Doa & Dzikir Harian — Amalize | Kumpulan Doa Muslim Lengkap" description="Kumpulan doa harian, dzikir pagi petang, doa sholat, dan Al-Ma'tsurat lengkap dengan teks Arab, latin, dan terjemahan. Gratis dari Amalize." path="/doa" />
      ...
      {searchOpen && (
        <form onSubmit={(e) => { e.preventDefault(); searchInputRef.current?.blur(); }} className="relative">
          <input
            ...
            autoFocus
          />
          <button type="button" onClick={() => { setSearchOpen(false); setSearchQuery(''); }} className="absolute left-3 top-1/2 -translate-y-1/2 p-0 text-muted-foreground hover:text-foreground">
