          ...
          <div className="relative">
            ...
            {showSettings && (
              <>
                ...
                <div className="absolute right-0 top-10 z-50 w-80 rounded-xl bg-card p-4 shadow-lg border border-border space-y-3 max-h-[80vh] overflow-y-auto">
                  <div>
                    ...
                    <p className="text-[10px] leading-snug text-muted-foreground mt-1">
                      Koreksi waktu digunakan untuk menyesuaikan jadwal sholat agar lebih akurat sesuai kondisi lokasi Anda atau mengikuti jadwal masjid setempat. Contoh: Jika Maghrib berbeda 2 menit dari masjid, tambahkan +2. Jika lebih cepat, kurangi menitnya.
                    </p>
                  </div>
                  {ALL_PRAYERS.map(p => (
